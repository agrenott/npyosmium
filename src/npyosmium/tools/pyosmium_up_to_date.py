...
subsequent calls to npyosmium-up-to-date will continue the updates from the same
...
npyosmium-up-to-date does not fetch the cookie from these services for you.
...
def get_arg_parser(from_main=False):
    ...
    parser = ArgumentParser(prog='npyosmium-up-to-date',
                            description=__doc__,
                            usage=None if from_main else 'npyosmium-up-to-date [options] <osm file>',
