...
class FileProcessor:
    ...
    def with_areas(self, *filters: 'npyosmium._osmium.HandlerLike') -> 'FileProcessor':
    ...
    def with_filter(self, filt: 'npyosmium._osmium.HandlerLike') -> 'FileProcessor':
    ...
    def __iter__(self) -> Iterator[OSMEntity]:
        ...
        """
        handlers: List['npyosmium._osmium.HandlerLike'] = []
