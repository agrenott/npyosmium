...
class DanglingReferenceBase:
    ...
    def test_keep_reference(self):
        h = npyosmium.make_simple_handler(node=self.node, way=self.way,
    ...
    def test_keep_reference_generator(self):
        for obj in npyosmium.FileProcessor(TEST_DIR / 'example-test.osc').with_areas():
...
class NotADanglingReferenceBase:
    ...
    def test_keep_reference_generator(self):
        for obj in npyosmium.FileProcessor(TEST_DIR / 'example-test.pbf').with_areas():
